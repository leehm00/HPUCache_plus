...
inline char RandomByteGenerator::Next() {
  if (off_ == 6) {
    ...
    buf_[0] = static_cast<char>((bytes & 31)         % 26 + 'A');
    buf_[1] = static_cast<char>(((bytes >> 5) & 63)  % 26 + 'A');
    buf_[2] = static_cast<char>(((bytes >> 10) & 95) % 26 + 'A');
    buf_[3] = static_cast<char>(((bytes >> 15) & 31) % 26 + 'A');
    buf_[4] = static_cast<char>(((bytes >> 20) & 63) % 26 + 'A');
    buf_[5] = static_cast<char>(((bytes >> 25) & 95) % 26 + 'A');
    /* buf_[0] = 'A'; */
    /* buf_[1] = 'b'; */
    /* buf_[2] = 'C'; */
    /* buf_[3] = 'd'; */
